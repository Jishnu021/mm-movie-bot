...
<b>An Advanced File Search Bot Created by @mastermindmayankproject :)
...
Source: <a href='t.me/mastermindmayank_bots/12'>purchase source code</a>

<b>DEVS:</b>
- <a href='https://t.me/mastermindmayankproject'>Mastermind Mayank</a>
...
• /broadcast - to broadcast a message to all users."""
    ...
    STATUS_TXT = """<b>Join @mastermindmayankproject for more</b>
...
<b>Free Storage:</b> <code>{}</code> MiB"""
    ...
    FORCESUB_TXT = """You Will Have To Join Our Official Channel to access this file
...
<b>Example:</b> <code>/ytthumb https://youtu.be/6PtzFYaMxQ</code>
