...
async def next_page(bot, query):
    ...
    if int(ad_user) in ADMINS:
        ...
        return await query.answer(
            "𝐋𝐢𝐧𝐤 𝐄𝐱𝐩𝐢𝐫𝐞𝐝 𝐊𝐢𝐧𝐝𝐥𝐲 𝐏𝐥𝐞𝐚𝐬𝐞 𝐒𝐞𝐚𝐫𝐜𝐡 𝐀𝐠𝐚𝐢𝐧 🙂.",
            show_alert=True)
    try:
        offset = int(offset)
    except:
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/+2a_B8ZjwuRc5NGJl"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/+2a_B8ZjwuRc5NGJl")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.answer("🔰Dont Add Movie Series request etc\n🔰check spelling and release date from google or imdb before request\n🔰 For better results:\n\t\t\t\t\t\t- MovieName year\n\t\t\t\t\t\t- Eg: Kuruthi 2021\n\n©mastermindmayank", True)
    elif query.data == 'reqst1':
        await query.answer("🎯 Click On The Button below select desired file size and start the bot ⬇️", True)
    elif query.data == 'info':
        ...
        await query.answer(" ♦️If You Not See Your Files On This Page Then Click On Next Page..😌,",show_alert=True)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>🎬 Title:</b> {search}\n</b>\n<b><a href='https://t.me/+2a_B8ZjwuRc5NGJl'>Series & Movies Studio</a></b>\n\n<b> Join @mastermindmayankproject for more</b>"
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            fek = await message.reply_photo(photo="https://te.legra.ph/file/e4f1f518155934b8c2cdd.jpg", caption=cap, reply_to_message_id=reply_id, reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(36000)
            await fek.delete()
            await msg.delete()
    else:
        fuk = await message.reply_photo(photo="https://te.legra.ph/file/e4f1f518155934b8c2cdd.jpg", caption=cap, reply_to_message_id=reply_id, reply_markup=InlineKeyboardMarkup(btn))
        await asyncio.sleep(36000)
        await fuk.delete()
        await msg.delete()
    if spoll:
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        ...
        k = await msg.reply(f"No Movie/Series Related to <b>{search}</b> Was Found 🥺\n\nmessage @m4mastermindmayank to add this file or Check your spelling", reply_markup=button)
    ...
    m = await msg.reply("message @m4mastermindmayank to add this file\nor\nDid you mean any one of these?",
                    reply_markup=InlineKeyboardMarkup(btn))
